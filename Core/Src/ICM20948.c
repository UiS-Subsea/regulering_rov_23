...
void icm20948_init()
{
  ...
  return;
	...
	//icm20948_spi_slave_enable(); // for mag
...
bool icm20948_who_am_i()
{
	...
	if(icm20948_id == ICM20948_ID)
	  ...
	  print("Whoami failed, got: 0x%02X, expected: 0x%02X\r\n", icm20948_id, ICM20948_ID);
		return false;
}
...
void icm20948_gyro_calibration()
{
	...
	gyro_bias[0] /= GYRO_CALIB_SAMPLES;
	gyro_bias[1] /= GYRO_CALIB_SAMPLES;
	gyro_bias[2] /= GYRO_CALIB_SAMPLES;
...
void icm20948_accel_calibration()
{
	...
	accel_bias[0] /= ACCEL_CALIB_SAMPLES;
	accel_bias[1] /= ACCEL_CALIB_SAMPLES;
	accel_bias[2] /= ACCEL_CALIB_SAMPLES;
